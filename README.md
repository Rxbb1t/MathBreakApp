...
- **Adaptive difficulty.** A hidden 0-100 progress level bar moves with how you answer. Getting one wrong never drops it, and answering quickly carries you further than answering slowly.
...
- **Estimating, where close counts.** "Roughly how much is 297 × 4?" Round it, get a close answer and you succeed.
...
- **No countdown.** Nothing is ever timed. Solving something quickly still counts for more.
...
## Optional Permissions the app asks for
